...
<!--                <p class="google-font grey&#45;&#45;text mt-3" style="font-size:120%">{{chapterDetails.aboutGDGProgram}}</p>-->
                ...
                <v-btn :href="chapterDetails.ChapterMeetupLink" target="_blank" class="ma-0 google-font elevation-1" color="#1a73e8" style="text-transform: capitalize;border-radius:5px;color:white">Seja um membro</v-btn>
                &nbsp;

                <v-btn href="https://developers.google.com/groups" target="_blank" outline color="cyan" style="text-transform: capitalize;border-radius:5px"  class="ml-0" dark>Aprenda mais</v-btn>
            </v-flex> 
